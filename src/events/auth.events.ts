...
// USER_REGISTERED → welcome conversation
appEvents.on(AUTH_EVENTS.USER_REGISTERED, async (user) => {
  try {
    ...
    console.error(
      'Failed to create welcome conversation:',
      error,
    );
  }
});
